...
import animal.aves.cormorant.Cormorant;

import animal.aves.duck.Duck;

import animal.aves.eagle.Eagle;

import animal.aves.jalak.Jalak;

import animal.aves.owl.Owl;

import animal.aves.parrot.Parrot;

import animal.mammal.dolphin.Dolphin;

import animal.mammal.dugong.Dugong;

import animal.mammal.elephant.Elephant;

import animal.mammal.giraffe.Giraffe;

import animal.mammal.goat.Goat;

import animal.mammal.lion.Lion;

import animal.mammal.orca.Orca;

import animal.mammal.polarbear.PolarBear;

import animal.mammal.tiger.Tiger;

import animal.mammal.walrus.Walrus;

import animal.reptile.alligator.Alligator;

import animal.reptile.cobra.Cobra;

import animal.reptile.iguana.Iguana;

import animal.reptile.komodo.Komodo;

import cage.Cage;

import cell.Cell;

import cell.airhabitat.AirHabitat;

import cell.landhabitat.LandHabitat;

import cell.park.Park;

import cell.restaurant.Restaurant;
...
import cell.waterhabitat.WaterHabitat;
...
public class Zoo {
      ...
      while (sc.hasNextLine()) {
        ...
        if (c == 'A') {
          ...
          if ((getElement(abs - 1,ord - 1) instanceof LandHabitat)
              || (getElement(abs  -  1, ord  -  1) instanceof WaterHabitat)) {
  ...
  /**
    ...
    * @return Hasil konversi zoo dimulai dari (absAwal, ordAwal) sampai (ordAwal, ordAkhir).
    */
