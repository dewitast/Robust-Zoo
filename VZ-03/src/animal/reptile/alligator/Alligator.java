...
public class Alligator extends Reptile {
   ...
   * @return Mengembalikan true jika Alligator adalah hewan darat.
   */
   ...
   * @return Mengembalikan true jika Alligator adalah hewan air.
   */
   ...
   * @return Mengembalikan true jika Alligator adalah hewan udara.
   */
