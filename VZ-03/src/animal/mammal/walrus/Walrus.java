...
public class Walrus extends Mammal {
   ...
   * @return Mengembalikan true jika Walrus adalah hewan darat.
   */
   ...
   * @return Mengembalikan true jika Walrus adalah hewan air.
   */
   ...
   * @return Mengembalikan true jika Walrus adalah hewan udara.
   */
