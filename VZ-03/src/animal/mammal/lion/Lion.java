...
public class Lion extends Mammal {
   ...
   * @return Mengembalikan true jika Lion adalah hewan darat.
   */
   ...
   * @return Mengembalikan true jika Lion adalah hewan air.
   */
   ...
   * @return Mengembalikan true jika Lion adalah hewan udara.
   */
