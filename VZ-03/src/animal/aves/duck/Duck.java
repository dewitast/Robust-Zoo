...
public class Duck extends Aves {
   ...
   * @return Mengembalikan true jika Duck adalah hewan darat.
   */
   ...
   * @return Mengembalikan true jika Duck adalah hewan air.
   */
   ...
   * @return Mengembalikan true jika Duck adalah hewan udara.
   */
