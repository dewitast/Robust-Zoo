...
public class Eagle extends Aves {
   ...
   * @return Mengembalikan true jika Eagle adalah hewan darat.
   */
   ...
   * @return Mengembalikan true jika Eagle adalah hewan air.
   */
   ...
   * @return Mengembalikan true jika Eagle adalah hewan udara.
   */
